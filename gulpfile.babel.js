...
import manifest from 'gulp-appcache';
...
gulp.task('scripts', () =>
    gulp.src([
      ...
      './app/scripts/2wiscroll.js',
      './app/scripts/call2ws.js'
    ])
...
var manifestconfig = {
        ...
        filename: 'viewport.manifest',   //filename to generate
        exclude: 'viewport.manifest'   //What not to include
        };
